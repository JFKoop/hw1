...
let today = "Currently it is " + weatherData.current.temperature + " and " + weatherData.current.conditions + ".";
console.log(today);

let forecast = "Tomorrow it will be " + weatherData.forecast[0].temperature + " and " + weatherData.forecast[0].conditions + ". The next day we will see " + weatherData.forecast[1].conditions + " skies, with a temperature of " + weatherData.forecast[1].temperature + ".";
